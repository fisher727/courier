...
function v_fGirthCalculatorSubmit(obj){var parent=$(obj).closest(".dpd-girth-calculator");if(gc_checkValid(parent)){var h=parseFloat($(parent).find(".dimension-h").val().replace(",",".")),w=parseFloat($(parent).find(".dimension-w").val().replace(",",".")),l=parseFloat($(parent).find(".dimension-l").val().replace(",",".")),divisor=$(parent).find(".divisor").val(),max_girth=parseFloat($(parent).find(".max_girth").val());if(w>l&&w>=h){var tmp=w;w=l,l=tmp,$(parent).find(".dimension-w").val(w),$(parent).find(".dimension-l").val(l)}if(h>l&&h>=w){var tmp=h;h=l,l=tmp,$(parent).find(".dimension-h").val(h),$(parent).find(".dimension-l").val(l)}volweight_exact=h*w*l*100/divisor/100;var volweight=Math.ceil(volweight_exact),girth=parseFloat(2*(h+w)+l).toFixed(2);girth>max_girth?($(parent).find(".result_girth").removeClass("valid"),$(parent).find(".result_girth").addClass("invalid"),$(parent).find(".result_girth").html('<div class="close-x-big-icon"></div><div>'+girth_calculator_translated_messages.invalid_girth_text+"</div>")):($(parent).find(".result_girth").removeClass("invalid"),$(parent).find(".result_girth").addClass("valid"),$(parent).find(".result_girth").html('<div class="confirmation1-icon"></div><div>'+girth_calculator_translated_messages.valid_girth_text+"</div>")),$(parent).find(".calc_volweight").html(volweight),$(parent).find(".calc_girth").html(girth),$(parent).find(".girth-calculator .results").hasClass("active")||($(parent).find(".girth-calculator .results").addClass("active"),$(parent).find(".girth-calculator .results").attr("style","visibility: visible; height: 100%;"),$(parent).find(".error-box-calculator").css("display","none")),$(parent).css("margin-bottom","0px")}else $(parent).find(".girth-calculator .results").removeClass("active")}function gc_clearErrorField(parent){$(parent).find(".girth-calculator div").filter(".validation-failed").removeClass("validation-failed"),$(parent).find(".girth-calculator span").filter(".validation-error").removeClass("validation-error"),$(parent).find(".girth-calculator input").filter(".text-box").removeAttr("placeholder")}function gc_showErroField(parent,fieldName){$(parent).find(".girth-calculator ."+fieldName+"-div").attr("class","input-box validation-failed must-focus focus "+fieldName+"-div")}function gc_validateRequiredInputField(parent,fieldName){return!$(parent).find(".girth-calculator ."+fieldName).hasClass("required")||(!(""===$(parent).find(".girth-calculator ."+fieldName).val()||null===$(parent).find(".girth-calculator ."+fieldName).val()||isNaN($(parent).find(".girth-calculator ."+fieldName).val())||Number($(parent).find(".girth-calculator ."+fieldName).val())<1)||(gc_showErroField(parent,fieldName),$(parent).find(".error-box-input-not-less-1").css("display",""),$(parent).find(".girth-calculator .results").attr("style","visibility: hidden; height: 0;"),!1))}function gc_checkValid(parent){if(gc_clearErrorField(parent),$(parent).find(".girth-calculator .error-box-calculator").css("display","none"),""===$(parent).find(".dimension-h").val().trim()&&""===$(parent).find(".dimension-w").val().trim()&&""===$(parent).find(".dimension-l").val().trim())return $(parent).find(".error-box-input").css("display",""),$(parent).find(".girth-calculator .input-box").addClass("validation-failed"),$(parent).find(".girth-calculator .results").attr("style","visibility: hidden; height: 0;"),!1;var listIdInput=[],isValid=!0;listIdInput=["dimension-h","dimension-w","dimension-l"];for(var i=0;i<listIdInput.length;i++)isValid?isValid=gc_validateRequiredInputField(parent,listIdInput[i]):gc_validateRequiredInputField(parent,listIdInput[i]);var h=$(parent).find(".dimension-h").val(),w=$(parent).find(".dimension-w").val(),l=$(parent).find(".dimension-l").val(),maxLength=$(parent).find(".girth-calculator .max_length").val();return Number(h)>Number(maxLength)||Number(w)>Number(maxLength)||Number(l)>Number(maxLength)?($(parent).find(".error-box-calculator-max-length").css("display","block"),Number(h)>Number(maxLength)&&gc_showErroField(parent,"dimension-h"),Number(w)>Number(maxLength)&&gc_showErroField(parent,"dimension-w"),Number(l)>Number(maxLength)&&gc_showErroField(parent,"dimension-l"),isValid=!1,$(parent).find(".girth-calculator .results").css("display","none")):$(parent).find(".error-box-calculator-max-length").css("display","none"),isValid}function gc_checkInputValid(obj){var $this=$(obj);if($this.val()&&!isNaN(Number($this.val())))$this.val().match(/^\.[0-9]+$/gm)?$this.val(0+$this.val()):$this.val().match(/^[0-9]+\.$/gm)?$this.val($this.val()+0):$this.val().match(/^\-.[0-9]+$/gm)&&$this.val($this.val().substr(0,1)+0+$this.val().substr(1,$this.val().length));else if($this.val()&&isNaN(Number($this.val())))if($this.val().match(/^\.$/gm))$this.val(0);else if($this.val().match(/^[0-9.]+\-[0-9.]+$/gm)){var values=$this.val().split("-"),numbers={};$.each(values,function(index,value){var number=Number(value);isNaN(number)&&value.match(/^\.$/gm)&&(number=0),numbers[index]=number}),$this.val(Number(numbers[0])-Number(numbers[1]))}}function gc_validateInput(obj,e){var $this=$(obj);if(!(-1!==$.inArray(e.keyCode,[46,8,9,27,13])||65===e.keyCode&&(!0===e.ctrlKey||!0===e.metaKey)||67===e.keyCode&&(!0===e.ctrlKey||!0===e.metaKey)||86===e.keyCode&&(!0===e.ctrlKey||!0===e.metaKey)||88===e.keyCode&&(!0===e.ctrlKey||!0===e.metaKey)||e.keyCode>=35&&e.keyCode<=39)){if(-1!==$.inArray(e.keyCode,[110,190])){if(!$this.val().match(/(\.)/gm))return;e.preventDefault()}(e.shiftKey||e.keyCode<48||e.keyCode>57)&&(e.keyCode<96||e.keyCode>105)&&e.preventDefault(),$(this).bind("paste",function(e){var clipboardData,pastedData;(e.clipboardData||e.originalEvent.clipboardData||window.clipboardData).getData("text").match(/^([0-9]*[.])?[0-9]+$/)||e.preventDefault()}),13!==e.keyCode&&($(obj).closest(".dimension-h-div").filter(".validation-failed").removeClass("validation-failed"),$(obj).closest(".dimension-h-div").find(".dimension-h-span").filter(".validation-error").removeClass("validation-error"),$(obj).closest(".dimension-w-div").filter(".validation-failed").removeClass("validation-failed"),$(obj).closest(".dimension-h-div").find(".dimension-w-span").filter(".validation-error").removeClass("validation-error"),$(obj).closest(".dimension-l-div").filter(".validation-failed").removeClass("validation-failed"),$(obj).closest(".dimension-h-div").find(".dimension-l-span").filter(".validation-error").removeClass("validation-error"))}}function setGirthValues(obj){var dpd_girth_calculator=$(obj).closest(".dpd-girth-calculator");dpd_girth_calculator.find(".error-box-calculator").hide(),dpd_girth_calculator.find("div.input-box").removeClass("validation-failed");var girth_calc_type=$(obj).val(),girth_settings=dpd_girth_calculator.find(".girth-calculator-option-settings").data();"normal"===girth_calc_type?(dpd_girth_calculator.find(".girth-calculator .max_length").val(girth_settings.normalMaxLength),dpd_girth_calculator.find(".girth-calculator .max_girth").val(girth_settings.normalMaxGirth),dpd_girth_calculator.find(".girth-calculator .divisor").val(girth_settings.normalDivisor),dpd_girth_calculator.find(".girth-calculator p.special-text.header-notice").text(girth_calculator_translated_messages.normal_header_notice),dpd_girth_calculator.find(".girth-calculator .error-box-calculator-max-length").find("p").text(girth_calculator_translated_messages.normal_max_length_error)):"parcel"===girth_calc_type&&(dpd_girth_calculator.find(".girth-calculator .max_length").val(girth_settings.parcelshopMaxLength),dpd_girth_calculator.find(".girth-calculator .max_girth").val(girth_settings.parcelshopMaxGirth),dpd_girth_calculator.find(".girth-calculator .divisor").val(girth_settings.parcelshopDivisor),dpd_girth_calculator.find(".girth-calculator p.special-text.header-notice").text(girth_calculator_translated_messages.parcel_header_notice),dpd_girth_calculator.find(".girth-calculator .error-box-calculator-max-length").find("p").text(girth_calculator_translated_messages.parcel_max_length_error))}$(".so-widget-dpd-at-girth-calculator-widget").closest(".panel-widget-style").addClass("row-fix-margin-auto"),$(".so-widget-dpd-at-girth-calculator-widget").addClass("padding-background-ats");
/*!
